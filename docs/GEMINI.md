...
> feature, skill, CLI, or service — starts in [`mbo/`](./mbo/GEMINI.md)** (Management By
...
- [`mbo/`](./mbo/) — design · spec · plan artifacts + the objective tracker. Read
  [`mbo/GEMINI.md`](./mbo/GEMINI.md) first.

## Reference guides (not objective artifacts)

- [`ai-plugins.md`](./ai-plugins.md) — the Claude/Gemini plugin catalog + mapping.
