...
| :-- | :-- | :-- | :-- | :-- |
| **F1** keys + lint | [ ] `lint_test.go` table | [ ] IH-1, IA-3 | [ ] demo step 2 | |
| **F2** bool semantics | [ ] schema/resolve tests | [ ] IH-3, IH-5 | [ ] demo steps 2–3 | |
...
| `internal/schema` | ≥90% | _(not measured)_ | `go test ./internal/schema/ -cover` |
