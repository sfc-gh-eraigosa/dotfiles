...
| :-- | :-- | :-- | :-- | :-- |
| T0 spec + plan + trio | done | _(this commit)_ | files present under docs/mbo; index row → building | design marked Approved |
| T1 aliases.sh in the Claude shape | todo | | | |
...
| :-- | :-- | :-- | :-- |
| F1 launch config | [ ] aliases_test.sh | [ ] `agy-config status` transcript | |
...
| 2026-09-03 | loop-1 | design Approved by user; spec, plan, trio written; index → building |
