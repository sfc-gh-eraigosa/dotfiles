...
| P1-T1 gcfg scaffold + CI | done | (this commit) | `go test ./... -count=1 -cover` → main 91.7% · cmd 100% · version 100%; module total 96.7% ≥80; `go run . version`; actionlint clean → [evidence/P1-T1/2026-09-05.txt](./evidence/P1-T1/2026-09-05.txt) | gcfg-ci gates 80/90/90; schema-drift + actionlint + leak-grep steps skip themselves until P3/P5 produce their inputs |
