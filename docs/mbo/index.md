...
| `gff-tui-vim` | — (bounded change to the existing `gff` TUI; design decided in-chat, recorded in the spec) | [spec](./specs/gff-tui-vim.md) | [plan](./plans/gff-tui-vim.md) + [trio](./plans/gff-tui-vim/) | [#281](https://github.com/sfc-gh-eraigosa/dotfiles/issues/281) | design [#280](https://github.com/sfc-gh-eraigosa/dotfiles/pull/280) (draft) | planning — **unblocked**: `sdk-tui` landed on `main` 2026-09-05 (`70629d1`); first consumer of `sdk/libs/tui`; re-planned 2026-09-05 to 4 tasks; build worker now bases on `main`; kickoff reads `plans/sdk-tui/TRACKING.md` §4 (split multi-rune paste batches, count all chrome lines) |
