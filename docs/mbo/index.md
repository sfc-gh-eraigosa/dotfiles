...
| :-- | :-- | :-- | :-- | :-- | :-- | :-- |
| `sdk-tui` | [design](./designs/sdk-tui.md) + guide `sdk/libs/tui/GUIDE.md` | [spec](./specs/sdk-tui.md) | [plan](./plans/sdk-tui.md) + [trio](./plans/sdk-tui/) | [#283](https://github.com/sfc-gh-eraigosa/dotfiles/issues/283) | design [#286](https://github.com/sfc-gh-eraigosa/dotfiles/pull/286) (draft) · lib [#288](https://github.com/sfc-gh-eraigosa/dotfiles/pull/288) (stacked on #286; ready for review) | in-review (shared TUI behaviors lib `sdk/libs/tui`: keymap · nav · prompt · search · cmdline · overlay; **blocks `gff-tui-vim`**; phase 3 = fleet port + gsl config studio) |
