...
| `gcfg` | [design](./designs/gcfg.md) | [spec](./specs/gcfg.md) | [plan](./plans/gcfg.md) + [trio](./plans/gcfg/) | [#284](https://github.com/sfc-gh-eraigosa/dotfiles/issues/284) | design (this PR) | designing (GitHub config as code — `.github/gcfg.yaml`, verify/apply/export/init, TUI, two Actions, PAT or GitHub App via the reusable `sdk/ghapp`; POC: gh token covers repo settings, `GITHUB_TOKEN` cannot, org needs `admin:org`) |
