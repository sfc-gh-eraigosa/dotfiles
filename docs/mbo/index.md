...
| `agy-parity` | [design](./designs/agy-parity.md) | — | — | [#268](https://github.com/sfc-gh-eraigosa/dotfiles/issues/268) | design draft PR (pending) | designing (agy 1.1.25 startup contract matched to Claude: launch config, settings seed, deny/ask policy, hooks merge, commands + memories as a local plugin) |
