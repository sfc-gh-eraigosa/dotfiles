...
| `wlink` | [design](./designs/wlink.md) | [spec](./specs/wlink.md) | [plan](./plans/wlink.md) + [trio](./plans/wlink/) | [#245](https://github.com/sfc-gh-eraigosa/dotfiles/issues/245) | design docs ride with [#242](https://github.com/sfc-gh-eraigosa/dotfiles/pull/242) (the shell predecessor `wlink` succeeds) | planning (design·spec·plan approved, trio laid down; **build gated on #242 merging** — never two live DNS rewriters) |
