...
| `sdk-tui` | [design](./designs/sdk-tui.md) + guide `sdk/libs/tui/GUIDE.md` | [spec](./specs/sdk-tui.md) | [plan](./plans/sdk-tui.md) + [trio](./plans/sdk-tui/) | [#283](https://github.com/sfc-gh-eraigosa/dotfiles/issues/283) | design [#286](https://github.com/sfc-gh-eraigosa/dotfiles/pull/286) · lib [#288](https://github.com/sfc-gh-eraigosa/dotfiles/pull/288) — both merged 2026-09-05 (`main` @ `70629d1`) | done (shared TUI behaviors lib `sdk/libs/tui`: keymap · nav · prompt · search · cmdline · overlay; unblocks `gff-tui-vim`; phase 3 = fleet port + gsl config studio) |
...
| `gff-tui-vim` | — (bounded change to the existing `gff` TUI; design decided in-chat, recorded in the spec) | [spec](./specs/gff-tui-vim.md) | [plan](./plans/gff-tui-vim.md) + [trio](./plans/gff-tui-vim/) | [#281](https://github.com/sfc-gh-eraigosa/dotfiles/issues/281) | design [#280](https://github.com/sfc-gh-eraigosa/dotfiles/pull/280) (merged 2026-09-06 as `6c43686`) · build [#304](https://github.com/sfc-gh-eraigosa/dotfiles/pull/304) (re-targeted to `main`) | in-review — first consumer of `sdk/libs/tui` (landed on `main` 2026-09-05 `70629d1`): vim motions, `/` smartcase search with auto-expand + `n`/`N`, `:set`/`:unset`/`:/re`/`:help`/`:q` with Tab completion, help on `?`/F1. Tasks 1–4 done; module 91.0%, `internal/tui` 92.6%, real-terminal demo in `plans/gff-tui-vim/evidence/demo/` |
