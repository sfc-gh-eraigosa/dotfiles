...
| `gff-install-flow` | — | [spec](./specs/gff-install-flow.md) | _(pending)_ | _(pending)_ | _(worker `gff-install-flow/edward-raigosa/impl`, draft PR pending)_ | planning (spec approved 2026-07-26; plan next) |
