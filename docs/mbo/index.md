...
| :-- | :-- | :-- | :-- | :-- | :-- | :-- |
| `sdk-tui` | [design](./designs/sdk-tui.md) + guide `sdk/libs/tui/GUIDE.md` | [spec](./specs/sdk-tui.md) | [plan](./plans/sdk-tui.md) + [trio](./plans/sdk-tui/) | [#283](https://github.com/sfc-gh-eraigosa/dotfiles/issues/283) | design worker `sdk-tui/…/design` (draft PR pending checkpoint) | planning (shared TUI behaviors lib `sdk/libs/tui`: keymap · nav · prompt · search · cmdline · overlay; **blocks `gff-tui-vim`**; phase 3 = fleet port + gsl config studio) |
