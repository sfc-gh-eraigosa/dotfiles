...
| `gff-tui-vim` | — (bounded change to the existing `gff` TUI; design decided in-chat, recorded in the spec) | [spec](./specs/gff-tui-vim.md) | [plan](./plans/gff-tui-vim.md) + [trio](./plans/gff-tui-vim/) | [#281](https://github.com/sfc-gh-eraigosa/dotfiles/issues/281) | design [#280](https://github.com/sfc-gh-eraigosa/dotfiles/pull/280) (draft) | planning — **blocked on `sdk-tui`** (first consumer of `sdk/libs/tui`; re-planned 2026-09-05 to 4 tasks; build worker stacks on the lib branch) |
