...
| `gff-install-flow` | — | [spec](./specs/gff-install-flow.md) | [plan](./plans/gff-install-flow.md) | — | planning [#193](https://github.com/sfc-gh-eraigosa/dotfiles/pull/193) (merged) · build [#194](https://github.com/sfc-gh-eraigosa/dotfiles/pull/194) (worker `gff-install-flow/edward-raigosa/build`) | building (T1–T5 done; T6 human matrix pending) |
