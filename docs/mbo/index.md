...
| `agy-parity` | [design](./designs/agy-parity.md) | [spec](./specs/agy-parity.md) | [plan](./plans/agy-parity.md) + [trio](./plans/agy-parity/) | [#268](https://github.com/sfc-gh-eraigosa/dotfiles/issues/268) | design draft [#269](https://github.com/sfc-gh-eraigosa/dotfiles/pull/269) | building (agy 1.1.25 startup contract matched to Claude: launch config, settings seed, deny/ask policy, hooks merge, commands + memories as a local plugin) |
