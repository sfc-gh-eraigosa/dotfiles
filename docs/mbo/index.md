...
| `gff-tui-vim` | — (bounded change to the existing `gff` TUI; design decided in-chat, recorded in the spec) | [spec](./specs/gff-tui-vim.md) | [plan](./plans/gff-tui-vim.md) + [trio](./plans/gff-tui-vim/) | [#281](https://github.com/sfc-gh-eraigosa/dotfiles/issues/281) | design [#280](https://github.com/sfc-gh-eraigosa/dotfiles/pull/280) (draft) | planning (spec + plan approved 2026-09-05; build = 7 sequential TDD tasks on one `build` worker) |
