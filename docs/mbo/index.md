...
| `wlink` | [design](./designs/wlink.md) | [spec](./specs/wlink.md) | [plan](./plans/wlink.md) | — (deliberately not opened until approved — design §8) | [#242](https://github.com/sfc-gh-eraigosa/dotfiles/pull/242) (proposal rides with the shell predecessor) | idea (proposal — awaiting build/no-build decision; **Option A "do nothing" is live**) |
