...
| `gff-install-flow` | — | [spec](./specs/gff-install-flow.md) | [plan](./plans/gff-install-flow.md) | — | [#193](https://github.com/sfc-gh-eraigosa/dotfiles/pull/193) (worker `gff-install-flow/edward-raigosa/impl`) | planning (spec + plan approved 2026-07-26; build next) |
