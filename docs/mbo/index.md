...
| `wlink` | [design](./designs/wlink.md) | [spec](./specs/wlink.md) | [plan](./plans/wlink.md) + [trio](./plans/wlink/) | [#245](https://github.com/sfc-gh-eraigosa/dotfiles/issues/245) | [#242](https://github.com/sfc-gh-eraigosa/dotfiles/pull/242) — design docs **and** the build | planning (design·spec·plan approved, trio laid down; built inside #242, where the shell prototype is also deleted — `main` only ever sees `wlink`) |
