...
| `gff-install-flow` | — | [spec](./specs/gff-install-flow.md) | [plan](./plans/gff-install-flow.md) | — | planning [#193](https://github.com/sfc-gh-eraigosa/dotfiles/pull/193) · build [#194](https://github.com/sfc-gh-eraigosa/dotfiles/pull/194) (both merged) | done (merged 2026-07-26; 4-run owner matrix green incl. the elevated-log wispr SKIP via -GffEnv; tail backlog in plans/gff-install-flow/IMPLEMENTATION.md §8) |
