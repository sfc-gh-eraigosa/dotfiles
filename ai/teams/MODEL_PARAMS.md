...
| Tier | When | Claude | Antigravity | Ollama |
|------|------|--------|-------------|--------|
| **fast** | automation, CI, rote | `model` + `effort` | `model` + `effort` | `FROM` + `num_ctx` |
...
| Field | Claude | Antigravity | Ollama |
|-------|--------|-------------|--------|
| model | `model:` | `model:` | `FROM` |
| effort/sampling | `effort:` | `effort:` | — |
| context | (n/a) | (n/a) | `PARAMETER num_ctx` |
