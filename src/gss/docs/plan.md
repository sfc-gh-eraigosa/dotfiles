...
- **Files**: `src/gss/internal/errors/errors.go`, `exitcodes.go`, `errors_test.go`.
...
- **Files**: `src/gss/internal/git/exec.go`, `exec_test.go`,
  `fake/runner.go`.
...
- **Files**: `src/gss/internal/gh/exec.go`, `pr.go` (types),
...
- **Files**: `src/gss/internal/version/version.go`,
  `version_test.go`, modified `src/gss/build.sh`.
...
- **Files**: `src/gss/internal/config/config.go`, `config_test.go`,
...
- **Files**: `src/gss/internal/identity/wordlist.go`,
...
- **Files**: `src/gss/internal/identity/suffix.go`,
...
- **Files**: `src/gss/internal/identity/user.go`, `purpose.go`,
...
- **Files**: `src/gss/internal/repo/nwo.go`, `nwo_test.go`,
  `cache.go`.
...
- **Files**: `src/gss/internal/approval/approval.go`,
  `approval_test.go`.
...
- **Acceptance**: bit-identical semantics to current
  `src/gss/cmd/push.go` token handling, regression-tested against
...
- **Files**: `src/gss/internal/backup/backup.go`, `backup_test.go`.
...
- [ ] Design: [Existing features](./design.md#existing-features-that-must-survive-the-refactor).
- **Files**: `src/gss/internal/status/status.go`, `status_test.go`.
...
- **Acceptance**: byte-identical to current `src/gss/cmd/status.go`
...
- **Files**: `src/gss/cmd/gss/status.go`, `diff.go`, `version.go`,
...
- [ ] Design: [Code layout](./design.md#code-layout).
- **Files**: `src/gss/cmd/gss/scan.go`, `backup.go`, `sync.go`,
...
- **Files**: `src/gss/internal/registry/registry.go`, `schema.go`,
  `schema_test.go`.
...
- **Files**: `src/gss/internal/registry/lock.go`, `lock_test.go`,
...
- **Files**: `src/gss/internal/registry/reconcile.go`,
  `reconcile_test.go`.
...
- **Files**: `src/gss/internal/worktree/backend.go`,
...
- **Files**: `src/gss/internal/worktree/git/git.go`,
  `git_test.go`.
...
- **Files**: `src/gss/internal/classic/push.go`,
  `push_test.go`.
...
- **Acceptance**: behavioural equivalence to current
  `src/gss/cmd/push.go` against the golden snapshot from PR-15
...
- **Files**: `src/gss/cmd/gss/push.go`, `push_test.go`.
...
- **Files**: `src/gss/internal/classic/pr.go`, `pr_test.go`.
...
- **Files**: `src/gss/cmd/gss/pr.go`, `pr_test.go`.
...
- **Files**: `src/gss/internal/mode/mode.go`, `mode_test.go`.
...
- **Files**: `src/gss/internal/stack/stack.go`, `stack_test.go`.
...
- **Files**: `src/gss/internal/stack/body.go`, `body_test.go`,
...
- **Files**: `src/gss/internal/stack/restack.go`,
  `restack_test.go`.
...
- **Files**: `src/gss/internal/tmpl/render.go`, `render_test.go`.
...
- **Files**: `src/gss/internal/tmpl/tmpl.go`,
...
- **Files**: `src/gss/internal/feature/start.go`, `worker.go`,
...
- **Files**: `src/gss/internal/feature/list.go`, `list_test.go`.
...
- **Files**: `src/gss/internal/feature/conflicts.go`,
  `conflicts_test.go`.
...
- **Files**: `src/gss/internal/feature/checkpoint.go`,
  `checkpoint_test.go`.
...
- **Files**: `src/gss/internal/feature/auto.go`, `auto_test.go`.
...
- **Files**: `src/gss/internal/feature/pr.go`, `pr_test.go`.
...
- **Files**: `src/gss/internal/feature/rebase.go`,
  `rebase_test.go`.
...
- **Files**: `src/gss/internal/feature/restack.go`,
  `restack_test.go`.
...
- **Files**: `src/gss/internal/feature/done.go`,
  `done_test.go`.
...
- **Files**: `src/gss/internal/feature/merged.go`,
  `merged_test.go`.
- **Tests first**:
...
- **Files**: `src/gss/internal/feature/audit.go`,
  `audit_test.go`.
...
- **Files**: `src/gss/internal/feature/audit_xmachine_test.go`,
...
- **Files**: `src/gss/cmd/gss/feature/feature.go`.
...
- [ ] Design: [Code layout](./design.md#code-layout).
- **Files**: `src/gss/cmd/gss/main.go` (move from `src/gss/cmd/`),
  `src/gss/cmd/gss/config/config.go`, `config_test.go`,
  removal of old `src/gss/cmd/` flat layout.
...
- **Files**: `src/gss/build.sh`, optional CI workflow if applicable.
...
#### PR-52: `src/gss/skill/SKILL.md` worker / power-user surface
- [ ] Design: [Skill doc updates → src/gss/skill](./design.md#skill-doc-updates).
- **Files**: `src/gss/skill/SKILL.md`.
...
- **Files**: aggregate diff from all merged deliverables, plus a
  one-page release / migration note at `src/gss/docs/RELEASE.md`.
