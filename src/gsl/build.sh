...
LDFLAGS="-X github.com/wenlock/dotfiles/gsl/internal/version.Version=$VERSION \
         -X github.com/wenlock/dotfiles/gsl/internal/version.Commit=$COMMIT \
         -X github.com/wenlock/dotfiles/gsl/internal/version.BuildDate=$DATE \
         -X github.com/wenlock/dotfiles/gsl/internal/version.Dirty=$DIRTY"
